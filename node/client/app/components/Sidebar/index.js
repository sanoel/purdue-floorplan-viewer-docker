...
export default connect({
  app_ready: 'app.ready',
  hint: 'sidebar.searchbar.hint',
  text: 'sidebar.searchbar.text',
  error: 'sidebar.error',
}, {
  searchChanged: 'sidebar.searchBarInputChanged',
  searchSubmit: 'app.frontPageRequested',
  requestLoading: 'viewer.loadingPageRequested',
          ...
          <div className={styles['searchbar-container']}>
            <Paper className={styles['searchbar']}>
              <TextField 
                ...
                underlineShow={false}
                onChange={(evt) => this.props.searchChanged({searchbar_input: evt.target.value})}
